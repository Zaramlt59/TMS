...
export const masterDataService = {
  schoolType: {
    async getAll(): Promise<any[]> {
      try {
        return await prisma.school_types.findMany({
    ...
    async getById(id: number): Promise<any | null> {
      try {
        return await prisma.school_types.findUnique({
          where: { id }
        })
      } catch (error) {
    ...
    async create(data: any): Promise<any> {
      try {
        return await prisma.school_types.create({
          data
        })
      } catch (error) {
    ...
    async update(id: number, data: any): Promise<any> {
      try {
        return await prisma.school_types.update({
          where: { id },
          data
        })
      } catch (error) {
  ...
  medium: {
    ...
    async create(data: any): Promise<any> {
      try {
        return await prisma.mediums.create({
          data
        })
      } catch (error) {
    ...
    async update(id: number, data: any): Promise<any> {
      try {
        return await prisma.mediums.update({
          where: { id },
          data
        })
      } catch (error) {
  ...
  managementType: {
    async getAll(): Promise<any[]> {
      try {
        return await prisma.management_types.findMany({
          where: { is_active: true },
          orderBy: { name: 'asc' }
        })
      } catch (error) {
    ...
    async getById(id: number): Promise<any | null> {
      try {
        return await prisma.management_types.findUnique({
          where: { id }
        })
      } catch (error) {
    ...
    async create(data: any): Promise<any> {
      try {
        return await prisma.management_types.create({
          data
        })
      } catch (error) {
    ...
    async update(id: number, data: any): Promise<any> {
      try {
        return await prisma.management_types.update({
          where: { id },
          data
        })
      } catch (error) {
  ...
  blockOffice: {
    async getAll(): Promise<any[]> {
      try {
        return await prisma.block_offices.findMany({
          where: { is_active: true },
          orderBy: { name: 'asc' }
        })
      } catch (error) {
    ...
    async getById(id: number): Promise<any | null> {
      try {
        return await prisma.block_offices.findUnique({
          where: { id }
        })
      } catch (error) {
    ...
    async create(data: any): Promise<any> {
      try {
        return await prisma.block_offices.create({
          data
        })
      } catch (error) {
    ...
    async update(id: number, data: any): Promise<any> {
      try {
        return await prisma.block_offices.update({
          where: { id },
          data
        })
      } catch (error) {
  ...
  religion: {
    async getAll(): Promise<any[]> {
      try {
        return await prisma.religions.findMany({
          where: { is_active: true },
          orderBy: { name: 'asc' }
        })
      } catch (error) {
    ...
    async getById(id: number): Promise<any | null> {
      try {
        return await prisma.religions.findUnique({
          where: { id }
        })
      } catch (error) {
    ...
    async create(data: any): Promise<any> {
      try {
        return await prisma.religions.create({
          data
        })
      } catch (error) {
    ...
    async update(id: number, data: any): Promise<any> {
      try {
        return await prisma.religions.update({
          where: { id },
          data
        })
      } catch (error) {
