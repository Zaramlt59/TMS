...
export const cascadeController = {
  // Get cascade information for school deletion
  getSchoolCascadeInfo: async (req: Request, res: Response) => {
    try {
      const { schoolId } = req.params;
      const cascadeInfo = await cascadeService.getSchoolCascadeInfo(schoolId);
  ...
  getUserCascadeInfo: async (req: Request, res: Response) => {
    try {
      const { userId } = req.params;
      const cascadeInfo = await cascadeService.getUserCascadeInfo(parseInt(userId));
  ...
  safeDeleteSchool: async (req: Request, res: Response) => {
    try {
      const { schoolId } = req.params;
  ...
  safeDeleteTeacher: async (req: Request, res: Response) => {
    try {
      const { teacherId } = req.params;
      const force = req.query.force === 'true';
  ...
  safeDeleteUser: async (req: Request, res: Response) => {
    try {
      const { userId } = req.params;
      const force = req.query.force === 'true';
      
      const result = await cascadeService.safeDeleteUser(parseInt(userId), force);
  ...
  getDistrictCascadeInfo: async (req: Request, res: Response) => {
    try {
      const { districtId } = req.params;
      const cascadeInfo = await cascadeService.getDistrictCascadeInfo(parseInt(districtId));
  ...
  getRdBlockCascadeInfo: async (req: Request, res: Response) => {
    try {
      const { rdBlockId } = req.params;
      const cascadeInfo = await cascadeService.getRdBlockCascadeInfo(parseInt(rdBlockId));
  ...
  getVillageCascadeInfo: async (req: Request, res: Response) => {
    try {
      const { villageId } = req.params;
      const cascadeInfo = await cascadeService.getVillageCascadeInfo(parseInt(villageId));
  ...
  safeDeleteDistrict: async (req: Request, res: Response) => {
    try {
      const { districtId } = req.params;
      const force = req.query.force === 'true';
      
      const result = await cascadeService.safeDeleteDistrict(parseInt(districtId), force);
  ...
  safeDeleteRdBlock: async (req: Request, res: Response) => {
    try {
      const { rdBlockId } = req.params;
      const force = req.query.force === 'true';
      
      const result = await cascadeService.safeDeleteRdBlock(parseInt(rdBlockId), force);
  ...
  safeDeleteVillage: async (req: Request, res: Response) => {
    try {
      const { villageId } = req.params;
      const force = req.query.force === 'true';
      
      const result = await cascadeService.safeDeleteVillage(parseInt(villageId), force);
