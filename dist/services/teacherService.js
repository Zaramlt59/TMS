        ...
        if (data.posting_histories !== undefined) {
            transformed.posting_histories = data.posting_histories.map((posting) => ({
                ...
                block_office: (() => {
                    ...
                    if (/Education\s+Office.*CADC/i.test(bo))
                        return 'Education_Office_CADC_';
                    if (/Education\s+Office.*LADC/i.test(bo))
                        return 'Education_Office__LADC_';
                    if (/Education\s+Office.*MADC/i.test(bo))
                        return 'Education_Office__MADC_';
