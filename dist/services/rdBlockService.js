...
exports.rdBlockService = void 0;
const prismaService_1 = __importDefault(require("./prismaService"));
exports.rdBlockService = {
    // Get all active RD blocks
    async getAllActive() {
        try {
            return await prismaService_1.default.rd_blocks.findMany({
    ...
    async getById(id) {
        try {
            return await prismaService_1.default.rd_blocks.findUnique({
                where: { id },
                include: {
                    districts: true,
                    villages: true
    ...
    async create(data) {
        try {
            return await prismaService_1.default.rd_blocks.create({
                data,
                include: {
                    districts: true
                }
    ...
    async update(id, data) {
        try {
            return await prismaService_1.default.rd_blocks.update({
                where: { id },
                data,
                include: {
                    districts: true
...
//# sourceMappingURL=rdBlockService.js.map