...
export class SchoolTypeController {
  ...
  constructor() {
    this.schoolTypeService = new SchoolTypeService();
  }

  // Get all school types (including inactive)
  async getAllSchoolTypes(req: Request, res: Response) {
    try {
  ...
  async getAllSchoolTypesAdmin(req: Request, res: Response) {
    try {
      const result = await this.schoolTypeService.getAllSchoolTypes();
      res.json(result);
    } catch (error: any) {
  ...
  async getActiveSchoolTypes(req: Request, res: Response) {
    try {
  ...
  async getSchoolTypeById(req: Request, res: Response) {
    try {
  ...
  async createSchoolType(req: Request, res: Response) {
    try {
  ...
  // Update school type
  async updateSchoolType(req: Request, res: Response) {
    try {
      const id = parseInt(req.params.id);
  ...
  async deleteSchoolType(req: Request, res: Response) {
    try {
      const id = parseInt(req.params.id);
  ...
  async hardDeleteSchoolType(req: Request, res: Response) {
    try {
      const id = parseInt(req.params.id);
