                ...
                <td class="px-4 py-4 w-32 text-sm font-medium">
                  <div class="flex space-x-2">
                    <router-link
                      ...
                      class="text-primary-600 dark:text-blue-400 hover:text-primary-900 dark:hover:text-blue-300 group-hover:text-primary-700 dark:group-hover:text-blue-300"
                    >
                      Edit
                    </router-link>
                    <button
                      @click="deleteTeacher(teacher.id!)"
                      class="text-danger-600 dark:text-red-400 hover:text-danger-900 dark:hover:text-red-300 group-hover:text-danger-700 dark:group-hover:text-red-300"
                    >
                      Delete
                    </button>
                  </div>
