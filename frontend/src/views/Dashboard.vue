    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">
          Overview of the School & Teacher Data Entry System
        </p>
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div class="card-body text-center">
            <div class="w-12 h-12 bg-primary-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center mx-auto mb-3">
              <svg class="w-6 h-6 text-primary-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
              </svg>
            </div>
            <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">Add New School</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Create a new school record</p>
          </div>
        </router-link>
        ...
        >
          <div class="card-body text-center">
            <div class="w-12 h-12 bg-success-100 dark:bg-green-900/20 rounded-lg flex items-center justify-center mx-auto mb-3">
              <svg class="w-6 h-6 text-success-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
              </svg>
            </div>
            <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">Add New Teacher</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Create a new teacher record</p>
          </div>
        </router-link>
        ...
        >
          <div class="card-body text-center">
            <div class="w-12 h-12 bg-warning-100 dark:bg-yellow-900/20 rounded-lg flex items-center justify-center mx-auto mb-3">
              <svg class="w-6 h-6 text-warning-600 dark:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Manage master data</p>
          </div>
        </router-link>
        ...
        >
          <div class="card-body text-center">
            ...
            <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">View Schools</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Browse all school records</p>
          </div>
        </router-link>
        ...
        >
          <div class="card-body text-center">
            <div class="w-12 h-12 bg-danger-100 dark:bg-red-900/20 rounded-lg flex items-center justify-center mx-auto mb-3">
              <svg class="w-6 h-6 text-danger-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
              </svg>
            </div>
            <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">View Teachers</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Browse all teacher records</p>
          </div>
        </router-link>
      </div>
    </div>
