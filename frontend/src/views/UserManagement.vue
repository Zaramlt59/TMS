  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 card">
      <div class="card-body">
        ...
        <!-- Desktop Table View -->
        <div v-else class="hidden md:block overflow-x-auto -mx-4 sm:mx-0">
